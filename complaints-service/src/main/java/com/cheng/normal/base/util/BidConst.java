...
public class BidConst {
	...
	public static final String DEFAULT_MANAGER_PASSWORD = "1111";

	// 手机验证码有效时间(秒)
	public static final long VERIFYCODE_TIME_VALID = 180;
	// 邮箱验证有效时间(天)
	public static final long EMAIL_TIME_VALID = 5;
	...
	public static final BigDecimal MIN_WITHDRAW_AMOUNT = new BigDecimal("100.0000");// 系统最小提现金额
